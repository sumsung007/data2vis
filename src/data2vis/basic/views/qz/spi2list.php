    ...
    <div class="body-content">        
        <div class="row">
            ...
            <div class="col-lg-10">
                <h2>观测项列表</h2>
                <?PHP
                $url0 = "./index.php?r=qz/spi2list&pageNum";
                $para = '';
                ...
                foreach ($data1 as $s1)
                {
//                    $sp=sprintf("<td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td>",$s1['stationid'],$s1['itemid'],$s1['pointid'],
//                            $s1['stationname'],$s1['itemname']);
                    $sp=sprintf("<td>%s</td><td>%s</td><td>%s</td><td>%s</td>",$s1['stationid'],$s1['itemid'],
                            $s1['stationname'],$s1['itemname']);
