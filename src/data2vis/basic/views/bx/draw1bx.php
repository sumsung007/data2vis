...
if(isset(Yii::$app->session['bxRnd']))
{
    $bxRnd=Yii::$app->session['bxRnd'];
    $bxDrawed=1;
}
else
{
//    $bxRnd=Yii::app()->$session['bxRnd']; //使用先前随机产生的新内容
    $bxDrawed=0;    
}
...
//        var dt1="2015-11-25_"+(y1-8)+":"+m1+":"+d1;
        ...
        //保存rnd
        jQuery.ajax({
            url: './index.php?r=bx/ajax2rand&rnd='+rnd0,
            cache: false,
            success : function (html) {
                //rnd0=html;
                //alert("saved: "+rnd0); //ok，可能是因为返回了200
            }
        });
